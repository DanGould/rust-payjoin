...
pub(crate) fn pj_uri(
    ...
    let mut uri = crate::PjUri::new(session_context.address.clone(), extras);
    uri.set_amount(session_context.amount);
...
pub mod test {
    ...
    fn test_v2_pj_uri() {
        ...
        assert_ne!(uri.pj_param().endpoint().as_str(), EXAMPLE_URL);
